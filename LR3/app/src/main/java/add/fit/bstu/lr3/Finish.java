...
Bundle arguments=getIntent().getExtras();
        ...
        if (career.equals("новичок")) {
            vyvod.setText("Информация об игроке :\n" +
                ...
                //-----------------------------------------
            Player user = new Player(name, prozvishe,noga,career,position,vozrost,rost,ves,nation);
            users.add(user);
            ...
            //-------------------------------------------
            Player user = new Player(name, prozvishe,noga,career,position,vozrost,rost,ves,nation,date,lastcomand);
            users.add(user);
            adapter.notifyDataSetChanged();
